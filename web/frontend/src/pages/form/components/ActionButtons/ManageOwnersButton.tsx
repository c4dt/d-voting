...
const ManageOwnersButton = ({ handleManageOwners, formID, ongoingAction }) => {
  const { t } = useTranslation();
  const authCtx = useContext(AuthContext);

  return ongoingAction !== OngoingAction.ManageOwners ? (
    isManager(formID, authCtx) && (
      <button data-testid="manageOwnersButton" onClick={handleManageOwners}>
...
export default ManageOwnersButton;
